const product_data = [
  {
    url:
      "https://mechanicalkeyboards.com/shop/index.php?l=product_detail&p=5402",
    sku: "MY68N_1NWR2BnGJv",
    img_path: "images/products/large_MY68N1NWR2BnGJv_main.png",
    product_description: null,
    full_title:
      "Ducky x Varmilo MIYA Pro Koi 65% Dye Sub PBT Mechanical Keyboard",
    features: [
      "The MIYA Koi keyboard is a collaboration between Ducky, Varmilo, & Hua Culture Girls",
    ...
    brand: "Ducky x Varmilo",
    product_name: "MIYA Pro",
    size: "65%",
    frame_color: "red",
  ...
  },
  {
    ...
    sku: "DKON1887-_USPDZHBS",
    img_path: "images/products/large_DKON1887-USPDZHBS_main.jpg",
    product_description: null,
    full_title: "Ducky One 2 Skyline TKL Double Shot PBT Mechanical Keyboard",
    features: [],
    brand: "Ducky",
    product_name: "One 2",
    size: "Tenkeyless",
  ...
  },
  {
    ...
    sku: "MY68N_1WLLPaNDv",
    img_path: "images/products/large_MY68N1WLLPaNDv_main.png",
    product_description: null,
    full_title:
    ...
    mac_compatible: "yes",
    linux_compatible: "yes",
    dimensions: '4.13" x 13.27" x 2.09"',
    weight: "2.29 lbs",
    price: "$135.00",
    _type: "dict",
  },
  ...
  },
  {
    ...
    sku: "DKON1787ST-_USPDWWT_",
    img_path: "images/products/large_DKON1787ST-USPDWWT_main.jpg",
    product_description: null,
    full_title:
  ...
  },
  {
    ...
    sku: "DKON1808ST-_USPDAZT_",
    img_path: "images/products/large_DKON1808ST-USPDAZT1_main.jpg",
    product_description: null,
    full_title: "Ducky One 2 RGB LED  Double Shot PBT Mechanical Keyboard",
    features: [
      "10 additional PBT double - shot colorful keycaps (Random color)",
      "Supports RAZER Chroma Broadcast, Ducky Macro 2.0, and Ducky’s newest RGB software",
      "German made Cherry MX key switches",
  ...
  },
  {
    ...
    sku: "DKON1808-_USPDZHBS",
    img_path: "images/products/large_3485_large_DKON1808-USPDZHBS_main.jpg",
    product_description: null,
    full_title: "Ducky One 2 Skyline Double Shot PBT Mechanical Keyboard",
    features: [
      "3 level adjustable feet, Detachable 1.5 Meter USB Type-C cable, and Dual layer PCB",
      "German made Cherry MX key switches",
  ...
  },
  {
    ...
    sku: "MY68N_1PPP88V",
    img_path: "images/products/large_MY68N1PPP88V_main.jpg",
    product_description: null,
    full_title:
    ...
    mac_compatible: null,
    linux_compatible: null,
    dimensions: '13.27" x 4.13" x 2.00"',
    weight: "2.29 lbs",
    price: "$119.00",
    _type: "dict",
  },
  ...
  },
  {
    ...
    sku: "DKON1967ST-_USPDWWT_",
    img_path: "images/products/large_DKON1967ST-USPDWWT_main.jpg",
    product_description: null,
    full_title:
    ...
    features: [
      ...
      "3528 SMD RGB LEDs",
      "1000Hz polling rate",
      "Limit (1) Ducky One 2 SF per customer (strictly enforced)",
      "Includes either Year of the Rat or Year of the Ox spacebars",
    ],
    brand: "Ducky",
    product_name: "One 2 SF",
    size: "65%",
    frame_color: "white",
    primary_led_color: "RGB",
    hotswappable: "No",
  ...
  },
  {
    ...
    sku: "DKON1787ST-_USPDAZT_",
    img_path: "images/products/large_4284_large_DKON1787ST-USPDAZT1_main.jpg",
    product_description: null,
    full_title:
  ...
  {
    url:
      "https://mechanicalkeyboards.com/shop/index.php?l=product_detail&p=5593",
    sku: "DKME2061ST-_USPDAAT_",
    img_path: "images/products/large_5593_large_DKME1961ST-USPDAAT1_main.jpg",
    product_description: "\r\nVisit our ",
    full_title:
      "Ducky Mecha Mini v2 RGB LED  60% Double Shot PBT Mechanical Keyboard",
    features: [
      "Stunningly beautiful and robust Cast Aluminum 60% frame",
      "Dual layer PCB with a wide array of RGB lighting modes",
      "10 additional PBT Double Shot colorful keycaps ",
      "PBT double shot seamless keycaps",
      "Supports Ducky Macro 2.0 and features software free dipswitches for fast, reliable control",
      "Includes either Year of the Rat or Year of the Ox spacebars",
      "Limit (1) Ducky One 2 Mecha Mini per customer (strictly enforced)",
    ],
    brand: "Ducky",
    product_name: "Mecha Mini",
    size: "60%",
  ...
  },
  {
    ...
    sku: "DKON1967ST-_USPDAZT_",
    img_path: "images/products/large_DKON1967ST-USPDAZT1_main.jpg",
    product_description: null,
    full_title:
  ...
  },
  {
    ...
    sku: "DKON2061ST-_USPDWWT_",
    img_path: "images/products/large_5027_large_DKON1861ST-USPDWWT1_main.png",
    product_description: "\r\nVisit our ",
    full_title:
      "Ducky One 2 Mini Pure White - RGB LED 60% Double Shot PBT Mechanical Keyboard",
    features: [
      "10 additional PBT Double Shot colorful keycaps ",
      "Includes either Year of the Rat or Year of the Ox spacebars",
      ...
      "Brand new RGB lighting modes and mode architecture",
      "60% size, lightweight and extremely portable",
      "Limit (3) White Ducky One 2 Mini per customer (strictly enforced)",
    ],
    brand: "Ducky",
    product_name: "One 2 Mini",
    size: "60%",
    frame_color: "white",
    primary_led_color: "RGB",
    hotswappable: "No",
  ...
  },
  {
    ...
    img_path: "images/products/large_4322_large_DKON1861ST-USPDAZT1_main.png",
    product_description: "\r\nVisit our ",
    full_title:
    ...
    features: [
      ...
      "60% size, lightweight and extremely portable",
      "Includes either Year of the Rat or Year of the Ox spacebars",
      "Limit (3) Ducky One 2 Mini per customer (strictly enforced)",
    ],
    brand: "Ducky",
    product_name: "One 2 Mini",
    size: "60%",
  ...
  {
    url:
      "https://mechanicalkeyboards.com/shop/index.php?l=product_detail&p=8319",
    sku: "ME20PB-WH71-PSH_",
    img_path: "images/products/large_ME20PB-WH71-PSH_main.jpg",
    product_description: "\r\n",
    full_title:
      "Meko Push White 65% RGB LED Hotswap Bluetooth Double Shot ABS Mechanical Keyboard",
    features: [
      "Equipped with Hotswap sockets. Easily remove and install any MX based switch without soldering.",
      "Store up to 5 unique Bluetooth devices in Wireless Mode",
      "65% Layout with 71 key White ABS Double Shot Keycaps",
  ...
  {
    url:
      "https://mechanicalkeyboards.com/shop/index.php?l=product_detail&p=8318",
    sku: "ME20PB-BK71-P_",
    img_path: "images/products/large_ME20PB-BK71-P_main.jpg",
    product_description: "\r\n",
    full_title:
      "Meko Push Barebones 65% RGB LED Hotswap Bluetooth Mechanical Keyboard",
    features: [
      "Barebones only item!  Does not include switches or keycaps.",
      "Equipped with Hotswap sockets. Easily remove and install any MX based switch without soldering.",
      "Store up to 5 unique Bluetooth devices in Wireless Mode",
      "71 Key 65% Layout",
      "Rechargable Lithium Battery",
  ...
  {
    url:
      "https://mechanicalkeyboards.com/shop/index.php?l=product_detail&p=8317",
    sku: "ME20PB-BK71-PSH_",
    img_path: "images/products/large_ME20PB-BK71-PSH_main.jpg",
    product_description: "\r\n",
    full_title:
      "Meko Push 65% RGB LED Hotswap Bluetooth Double Shot ABS Mechanical Keyboard",
    features: [
      "Equipped with Hotswap sockets. Easily remove and install any MX based switch without soldering.",
      "Store up to 5 unique Bluetooth devices in Wireless Mode",
      "65% Layout with 71 key Black ABS Double Shot Keycaps",
      "RGB Backlit with multiple lighting modes",
      "Rechargable Lithium Battery",
      "Type C USB interface",
    ],
  ...
  {
    url:
      "https://mechanicalkeyboards.com/shop/index.php?l=product_detail&p=8316",
    sku: "ME20PB-WH61-B_",
    img_path: "images/products/large_ME20PB-WH61-B_main.jpg",
    product_description: "\r\n",
    full_title:
      "Meko Blink White Barebones 60% RGB LED Hotswap Bluetooth Mechanical Keyboard",
    features: [
      "Barebones only item!  Does not include switches or keycaps.",
      "Equipped with Hotswap sockets. Easily remove and install any MX based switch without soldering.",
  ...
  {
    url:
      "https://mechanicalkeyboards.com/shop/index.php?l=product_detail&p=8315",
    sku: "ME20PB-WH61-BNK_",
    img_path: "images/products/large_ME20PB-WH61-BNK_main.jpg",
    product_description: "\r\n",
    full_title:
    ...
    features: [
      "Equipped with Hotswap sockets. Easily remove and install any MX based switch without soldering.",
      "Store up to 3 unique Bluetooth devices in Wireless Mode",
      "60% Layout with 61 key White ABS Double Shot Keycaps",
      "RGB Backlit with multiple lighting modes",
      "Rechargable Lithium Battery",
      "Type C USB interface",
    ],
  ...
  {
    url:
      "https://mechanicalkeyboards.com/shop/index.php?l=product_detail&p=8314",
    sku: "ME20PB-BK61-B_",
    img_path: "images/products/large_ME20PB-BK61-B_main.jpg",
    product_description: "\r\n",
    full_title:
      "Meko Blink Barebones 60% RGB LED Hotswap Bluetooth Mechanical Keyboard",
    features: [
      "Barebones only item!  Does not include switches or keycaps.",
      "Equipped with Hotswap sockets. Easily remove and install any MX based switch without soldering.",
      "Store up to 3 unique Bluetooth devices in Wireless Mode",
  ...
  {
    url:
      "https://mechanicalkeyboards.com/shop/index.php?l=product_detail&p=8313",
    sku: "ME20PB-BK61-BNK_",
    img_path: "images/products/large_ME20PB-BK61-BNK_main.jpg",
    product_description: "\r\n",
    full_title:
      "Meko Blink 60% RGB LED Hotswap Bluetooth Double Shot ABS Mechanical Keyboard",
    features: [
      "Equipped with Hotswap sockets. Easily remove and install any MX based switch without soldering.",
      "Store up to 3 unique Bluetooth devices in Wireless Mode",
      "60% Layout with 61 key Black ABS Double Shot Keycaps",
      "RGB Backlit with multiple lighting modes",
      "Rechargable Lithium Battery",
      "Type C USB interface",
    ],
  ...
  },
  {
    ...
    sku: "VTG83_MSLV",
    img_path: "images/products/large_VTG83MSLV_main.jpg",
    product_description:
    ...
    full_title: "Vortex Race 3 TKL Dye Sub PBT Mechanical Keyboard",
    features: [],
    brand: "Vortex",
    product_name: "Race 3",
    size: "Tenkeyless",
...
const fc = product_data.map((p) => p.frame_color)

const variations = new Set()
fc.forEach((f) => variations.add(f))
